...
class MyAccountManager(BaseUserManager):
    ...
    def create_superuser(self, email, password):
        ...
        user.first_name = 'Darts admin'
        user.last_name = 'Easy Groups admin'
        user.role = 'superuser'
        user.save(using=self._db)
        return user
...
class Account(AbstractBaseUser):
    ...
    ageType = models.CharField(default='Y', choices=ages, max_length=7)
    ...
    isReferee = models.BooleanField(default=False)
